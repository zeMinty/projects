...
def search(typesearch:str, textsearch:str)->None:
	if typesearch=='П' or typesearch=='п': wopen ('https://www.google.com/search?q=' + textsearch)
	elif typesearch=='К' or typesearch=='к': wopen ('https://www.google.com/search?tbm=isch&q=' + textsearch)

def main()->None:
    while 1:
        textsearch = input('Введите запрос в формате: "Ид: Запрос"\nИдентификаторы: П - Стандартный поиск, К - Поиск картинок\n> ')
        if textsearch=='': break

...
for shift in range(26): #Пробежка по английскому алфавиту (26 букв)
	...
	for c in inp: #Пробежка по каждой букве
		if c in lower_chars: #Запись в выходную строку буквы малого регистра со сдвигом (по модулю 26)
			output = f'{output}{lower_chars[ (lower_chars.index(c)+shift)%26 ]}'
		elif c in upper_chars: #Запись в выходную строку буквы большого регистра со сдвигом (по модулю 26)
